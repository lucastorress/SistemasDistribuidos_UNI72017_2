 ...
 * 
 */
@WebServiceClient(name = "UsuarioWS", targetNamespace = "http://service.mural/", wsdlLocation = "http://localhost:8080/MuralRecadosWS/UsuarioWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USUARIOWS_QNAME = new QName("http://service.mural/", "UsuarioWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/MuralRecadosWS/UsuarioWS?wsdl");
    ...
    public UsuarioWS getUsuarioWSPort() {
        return super.getPort(new QName("http://service.mural/", "UsuarioWSPort"), UsuarioWS.class);
    }
    ...
    public UsuarioWS getUsuarioWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.mural/", "UsuarioWSPort"), UsuarioWS.class, features);
    }
